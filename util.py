...
def test(otherversion):
    ...
    for row in f.readlines():
        if len(row) > 2:
            ...
            calcpub, calcpriv = get_addr(gen_eckey(pkey=private))
...
print generate_from_privkey("5KgvTTyepNPd8z8TsMQ1c4vi2jXqH1kb3nokAFEUXTV3ezxFR4U")
#print get_addr(eckey);
print "Should be 13RBwAY42qJLwRJYUAqee7AnGtRzk9kAyM"
